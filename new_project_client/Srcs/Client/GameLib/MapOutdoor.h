...
class CMapOutdoor : public CMapBase
{
	...
	public:
		...
		float			GetHeightWithSource(float x, float y, bool* pbObjectHeightFound, bool* pbAreaObjectSyncPending);
	...
	public:
		...
		void			RenderTree(unsigned long ulRenderBitVector);
		void			RenderObjectShadowsToTexture();
		void			SetDrawDynamicShadow(bool bDrawDynamicShadow);
		bool			GetDrawDynamicShadow() const { return m_bDrawDynamicShadow; }
#endif

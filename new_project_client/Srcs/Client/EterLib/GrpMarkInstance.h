...
#include "Pool.h"
	...
	#include "../UserInterface/MarkImage.h"
#endif
...
class CGraphicMarkInstance
{
	...
	protected:
#ifdef GUILD_LARGE_ICON
		static constexpr int MARK_WIDTH		= GuildMarkDef::MARK_WIDTH;
		static constexpr int MARK_HEIGHT	= GuildMarkDef::MARK_HEIGHT;
		static constexpr int MARK_COL_COUNT	= GuildMarkDef::MARK_COL_COUNT;
#else
		enum
		{
			MARK_WIDTH = 16,

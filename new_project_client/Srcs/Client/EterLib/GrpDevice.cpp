	...
	DWORD* pOutMultiSampleQuality)
{
	...
	*pOutMultiSampleQuality = 0;
	...
	std::vector<D3DMULTISAMPLE_TYPE> candidates;
	candidates.reserve(3);
	switch (antialiasingLevel)
	{
	case 1:
		candidates.push_back(D3DMULTISAMPLE_2_SAMPLES);
		break;
	case 2:
		candidates.push_back(D3DMULTISAMPLE_4_SAMPLES);
		candidates.push_back(D3DMULTISAMPLE_2_SAMPLES);
		break;
	case 3:
		candidates.push_back(D3DMULTISAMPLE_8_SAMPLES);
		candidates.push_back(D3DMULTISAMPLE_4_SAMPLES);
		candidates.push_back(D3DMULTISAMPLE_2_SAMPLES);
		break;
	...
	for (const D3DMULTISAMPLE_TYPE testType : candidates)
	{

...
CGuildMarkDownloader::CGuildMarkDownloader()
{
	...
	static constexpr int MARK_RECV_BUF = SGuildMarkBlock::MAX_COMP_SIZE * GuildMarkDef::BLOCK_TOTAL + 64 * 1024;
	SetRecvBufferSize(MARK_RECV_BUF);
	SetSendBufferSize(sizeof(TPacketCGMarkCRCList) * 2);
#else

...
#pragma pack(1)
		...
		typedef struct SMobTable_r275
		{
			...
			BYTE bUnk263; //r5
			BYTE bUnk264[3]; //r6
		} TMobTable_r275; //new 2017/9 mob_proto type for zodiac

		typedef struct SMobTable_r276
		{
			enum EMobResists_r7
			{
				MOB_RESIST_SWORD,
			...
			BYTE bUnk263; //r5
			BYTE bUnk264[3]; //r6
		} TMobTable_r276; //new 2017/9 mob_proto type for zodiac

...
void initapp()
{
	...
	// IKASHOP global arama: HER ZAMAN 0/1 tanimli (root'ta getattr'siz erisim siyah ekran yaratmasin)
#ifdef ENABLE_IKASHOP_SEARCH
	PyModule_AddIntConstant(poModule, "ENABLE_IKASHOP_SEARCH",	1);
#else
	...
	PyModule_AddIntConstant(poModule, "__BL_FOG_FIX__",	1);
#else
	PyModule_AddIntConstant(poModule, "__BL_FOG_FIX__",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "GUILD_LARGE_ICON", 1);
#else

...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_SAFETRADE,	CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCSafeTrade), DYNAMIC_SIZE_PACKET));
#endif
...
// retain fallback path for parity [cli-exitgame:f91c31609e4c]
{
	if (__IsNotPing())
	{
		LogOutGame();
...
// keep branch order stable [cli-recvphase:b2ac6507e87d]
{

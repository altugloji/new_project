...
SHOW_LIMIT_SUPPORT_SKILL_LIST = [121, 122, 123, 124, 126, 127, 129, 128, 131, 137, 138, 139, 140, 141]
if app.ENABLE_MONSTER_HUNTER_SKILL:
	SHOW_LIMIT_SUPPORT_SKILL_LIST.append(144)
...
class CharacterWindow(ui.ScriptWindow):
	...
	def RefreshStatus(self):
		...
		try:
			...
			self.GetChild("Exp_Value").SetText(localeInfo.NumberToString(unsigned32(player.GetEXP())))
			self.GetChild("RestExp_Value").SetText(localeInfo.NumberToString(unsigned32(player.GetStatus(player.NEXT_EXP)) - unsigned32(player.GetStatus(player.EXP))))
			self.GetChild("HP_Value").SetText(localeInfo.NumberToString(player.GetStatus(player.HP)) + '/' + localeInfo.NumberToString(player.GetStatus(player.MAX_HP)))
			self.GetChild("SP_Value").SetText(localeInfo.NumberToString(player.GetStatus(player.SP)) + '/' + localeInfo.NumberToString(player.GetStatus(player.MAX_SP)))

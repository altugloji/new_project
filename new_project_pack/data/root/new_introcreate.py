...
class CreateCharacterWindow(ui.Window):
	...
	def Open(self):
		...
		pythonScriptLoader.LoadScriptFile( self.dlgBoard, "uiscript/new_createcharacterwindow.py")#uiScriptLocale.LOCALE_UISCRIPT_PATH + "New_CreateCharacterWindow.py")

...
class GameWindow(ui.ScriptWindow):
	...
	def Open(self):
		...
		if constInfo.TEST_BUILD_WATERMARK_ENABLE:
			...
			self.testBuildMark.SetFontName("Tahoma:14b")
			...
			self.testBuildMark.SetPackedFontColor(0xFFFFFFFF)
			...
			self.testBuildMark2.SetFontName("Tahoma:14b")
			self.testBuildMark2.SetPosition(0, 135)
			...
			self.testBuildMark2.SetPackedFontColor(0xFFFFFFFF)
